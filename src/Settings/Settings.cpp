...
void Settings::init() {
  QFile cfgFile(getDataDir().absoluteFilePath("Newton.cfg"));
...
void Settings::setStartOnLoginEnabled(bool _enable) {
  {
    ...
    if (_enable) {
      ...
      autorunFile.write("Name=Newton Wallet\n");
...
void Settings::saveSettings() const {
  QFile cfgFile(QDir(m_cmdLineParser->getDataDir()).absoluteFilePath("Newton.cfg"));
