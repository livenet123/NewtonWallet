// Copyright (c) 2016-2017, The Newton developers
//
...
AccountKeys DeterministicWalletAdapter::generate_keys_from_seed() {
  AccountKeys keys;
  ...
  try {
    ...
    Crypto::generate_keys_from_seed(keys.viewKeys.publicKey, keys.viewKeys.secretKey, second);
